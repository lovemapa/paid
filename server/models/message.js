...
let singleChatSchema = new Schema({
    ...
    to: {
        type: Schema.Types.ObjectId, ref: 'company'        // reciever
    },
    from: {
        type: Schema.Types.ObjectId, ref: 'company'        // sender
    },
    ...
    readBy: [{
        type: Schema.Types.ObjectId, ref: 'company' //user ids of all who has read the message
    }],
    isBlocked: {
    ...
    groupDelete: [{
        type: Schema.Types.ObjectId, ref: 'company' //user ids of deletedBy Users in Group
    }],
    singleDelete: [{
        type: Schema.Types.ObjectId, ref: 'company' //user ids of deletedBy Users in One to One Chat
    }],
    deleteConverstation: [{
        type: Schema.Types.ObjectId, ref: 'company' //user ids of deletedBy Users in One to One Chat
    }],
